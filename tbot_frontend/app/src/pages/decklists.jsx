...
function DecklistsPage() {
  ...
  return (
    <div className="deck-page">
      ...
      <Footer credits="Special thanks to everyone in the PVZH community who continues to contribute great decks and help grow the Tbot website and Discord bot." />
    </div>
  );
}
